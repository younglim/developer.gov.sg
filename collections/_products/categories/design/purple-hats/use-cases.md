...
<br />&emsp;&emsp;        i. Set any tags required to identify the GitLab runner you wish to run your pipeline, e.g. ship_docker.
<br />&emsp;&emsp;        ii. Replace <some registry> with the URL to docker image.
<br />&emsp;&emsp;        iii. Edit the accessibility scan parameters with the type of scan you want to run:
  <figure style="text-align: center">
